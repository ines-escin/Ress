...
#GUI
  ...
  Scenario: Cadastro de mesmo cnpj para diferentes tipos de usuário
    ...
    When eu tento cadastrar um usuário do tipo "Gerador de Resíduo" com o cnpj "81.623.418/0001-57" e login "ruteste"
  ...
  Scenario: Alterar informações de usuário e informar um cnpj já cadastrado
    ...
    Then eu posso ver os mesmos dados que eu via antes da alteração do usuário com cnpj "25.296.876/0001-58"

#Controle
  Scenario: Remover um usuário empresa coletora com solicitações de coleta confirmadas
    Given a empresa coletora cadastrada com o cnpj "11.022.440/0001-66" tem uma única solicitação de coleta do gerador de resíduo de cnpj "41.367.569/0001-77" confirmada.
    When o cadastro da empresa coletora com o cnpj "11.022.440/0001-66" é deletado do sistema
