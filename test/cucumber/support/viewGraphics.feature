...
#GUI
  Scenario: Nenhuma coleta realizada na última semana
    ...
    And O intervalo do eixo x é [7/10/2016, 13/10/2016]
  ...
  Scenario: Seleção de gráfico de coletas da última semana
    ...
    When Eu seleciono a opção “Última semana”
    Then Eu posso ver um gráfico Coletas x Data  cuja altura é 2 quando x = “13/10/2016” e 3 quando x = “16/10/2016”
    And O intervalo do eixo x é [11/10/2016, 17/10/2016]
  ...
  Scenario: Seleção de gráfico de coletas do último mês
    ...
    Then Eu posso ver um gráfico Coletas x Data  cuja altura é 5 quando x = “26/10/2016” e 6 quando x = “15/11/2016”
    And O intervalo do eixo x é [16/10/2016, 16/11/2016]
